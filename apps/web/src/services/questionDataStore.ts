...
export const QUESTION_DATA_MAP: Record<string, QuestionDossierItem> = {
  ...
  Q2: {
    ...
    coachingCritique: {
      ...
      criticalGaps: [
        'Did not quantify cache hit ratio progression during warming phases.',
      ],
      modelSuggestedRewrite:
  ...
  Q3: {
    ...
    coachingCritique: {
      ...
      criticalGaps: [
        'Could discuss compare-and-swap (CAS) database versioning constraints.',
      ],
      modelSuggestedRewrite:
  ...
  Q5: {
    ...
    coachingCritique: {
      ...
      criticalGaps: [
        'Could elaborate on batching and pipelining Read-Index requests to mitigate latency.',
      ],
      modelSuggestedRewrite:
