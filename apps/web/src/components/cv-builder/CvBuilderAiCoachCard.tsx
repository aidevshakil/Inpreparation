      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '16px' }}>
        ...
        >
          ...
          <p style={{ fontSize: '0.72rem', color: '#cbd5e1', lineHeight: 1.45, margin: 0 }}>
            The 12,000+ QPS and 34% P99 latency reduction provides exemplary signal for Staff/Principal role evaluation.
          </p>
        </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px' }}>
            ...
            <span style={{ fontSize: '0.74rem', fontWeight: 700, color: '#fbbf24' }}>
              Recommendation: Measure Tech Consolidation
            </span>
          </div>
          <p style={{ fontSize: '0.72rem', color: '#cbd5e1', lineHeight: 1.45, margin: 0 }}>
            Consider adding the team size or sprint velocity increase resulting from your GraphQL transition.
          </p>
        </div>
      </div>
